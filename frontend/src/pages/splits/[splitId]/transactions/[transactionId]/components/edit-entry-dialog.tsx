...
import { updateEntry } from "@/service/entry-service";
    ...
    <MobileDialog open={open} onClose={handleCancel}>
      ...
      >
        <DialogTitle>
          ...
          >
            <BaseForm.Title>Edit Entry: {initalEntry.name}</BaseForm.Title>
            <DeleteEntryDialogButton entry={initalEntry} onSubmit={onClose} />
          </Box>
        </DialogTitle>
        <DialogContent sx={{ paddingBottom: 0 }}>
          <DialogContentText>
            <BaseForm.Description>
              Edit the details of this entry. Entries are used to split up
